...
public final class AnbarModels {
    ...
    public record Material(Long id, Long qrupId, String qrupKodu, String qrupAdi, Long vahidId, String vahidAdi,
                           String ad,
                           String qisaAd, String barkod, BigDecimal minimumMiqdar, BigDecimal maksimumMiqdar,
                           BigDecimal stokBoleni,
                           BigDecimal stokVurmaEmsali, BigDecimal stokBolmeEmsali, Boolean mehvEdileBiler,
    ...
    public record EmeliyyatNovu(Long id, Long kateqoriyaId, String kateqoriyaKodu, String kateqoriyaAdi,
                                String istiqamet,
                                String kod, String ad, Boolean standartdir, String aciqlama, Integer siraNo,
                                Boolean aktiv) {
    }
