...
public class TeskilatController {
    ...
    public String list(@RequestParam(required=false)String q,@RequestParam(required=false)Long tipId,
            @RequestParam(required=false)String status,@RequestParam(required=false)String standart,Model m){
        var all=repo.siyahi();String query=q==null?"":q.trim().toLowerCase(AZ);
    ...
    @PostMapping("/teskilatlar/yeni") public String create(@RequestParam Long tipId,@RequestParam String ad,@RequestParam(required=false)String kod,@RequestParam(required=false)String qisaAd,@RequestParam(required=false)String bankHesabNomresi,@RequestParam(required=false)String seherNomresi,@RequestParam(required=false)String mobilNomre,@RequestParam(required=false)String vergiNomresi,@RequestParam(required=false)String selahiyyetliSexs,@RequestParam(defaultValue="false")boolean standartdir,RedirectAttributes a){flash(repo.yarat(tipId,ad,kod,qisaAd,bankHesabNomresi,seherNomresi,mobilNomre,vergiNomresi,selahiyyetliSexs,standartdir),a,"Təşkilat yaradıldı.");return "redirect:/teskilatlar";}
    @PostMapping("/teskilatlar/yenile") public String update(@RequestParam Long teskilatId,@RequestParam Long tipId,@RequestParam String ad,@RequestParam(required=false)String kod,@RequestParam(required=false)String qisaAd,@RequestParam(required=false)String bankHesabNomresi,@RequestParam(required=false)String seherNomresi,@RequestParam(required=false)String mobilNomre,@RequestParam(required=false)String vergiNomresi,@RequestParam(required=false)String selahiyyetliSexs,@RequestParam Integer siraNo,@RequestParam(defaultValue="false")boolean standartdir,@RequestParam(defaultValue="false")boolean aktiv,RedirectAttributes a){flash(repo.yenile(teskilatId,tipId,ad,kod,qisaAd,bankHesabNomresi,seherNomresi,mobilNomre,vergiNomresi,selahiyyetliSexs,siraNo,standartdir,aktiv),a,"Təşkilat yeniləndi.");return "redirect:/teskilatlar";}
